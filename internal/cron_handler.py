...
from data.pydantic.models import CronJobShared
...
class CronHandler:
    ...
    ) -> Union[CronJobShared, Tuple[CronJobShared, CronItem]]:
    ...
    def get_jobs_by_command(
            ...
            job_command,
            return_cron_item=False
    ) -> Union[List[CronJobShared], Tuple[List[CronJobShared], List[CronItem]]]:
